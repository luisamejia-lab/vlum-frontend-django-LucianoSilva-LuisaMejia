    ...
    <Card
      sx={{
        ...
        '&:hover': {
          ...
          borderColor: '#4DB6AC',
          boxShadow: '0 20px 30px -10px rgba(77, 182, 172, 0.4)'
        }
      }}
    >
      ...
      <CardMedia
      component="img"
      image={`${mediaUrl}/${director.picture}`}
      alt={director.name}
      ...
      <CardContent sx={{ flexGrow: 1, p: 2 }}>
        ...
        <Typography gutterBottom variant="h6" component="div" sx={{ fontWeight: 700, color: '#fff' }}>
          {director.name}
        </Typography>

        <Typography variant="body2" sx={{ color: '#FFAB91', fontWeight: 600 }}>
